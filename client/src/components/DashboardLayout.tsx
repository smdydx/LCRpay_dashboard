    ...
    <SidebarProvider style={style as React.CSSProperties}>
      <div className="flex h-screen w-full">
        ...
        <div className="flex flex-col flex-1 min-w-0">
          <header className="flex items-center justify-between px-3 md:px-6 py-3 md:py-4 border-b border-border/50 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 backdrop-blur-xl sticky top-0 z-50 shadow-lg flex-shrink-0">
            <div className="flex items-center gap-2 md:gap-4 animate-slide-in-right">
              ...
              <div className="flex items-center gap-2 md:gap-3 min-w-0">
                <div className="h-9 w-9 md:h-11 md:w-11 rounded-lg md:rounded-xl bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center shadow-2xl animate-scale-in hover:scale-110 transition-transform duration-300 flex-shrink-0">
                  <BarChart3 className="h-4 w-4 md:h-6 md:w-6 text-white" />
                </div>
                <div className="hidden sm:block min-w-0">
                  <h1 className="text-base md:text-xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent truncate">
                    Analytics Dashboard
                  </h1>
