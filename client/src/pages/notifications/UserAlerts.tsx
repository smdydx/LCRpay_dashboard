  ...
  return (
    <div className="p-4 md:p-6 space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-muted-foreground mt-1" data-testid="text-page-description">Manage user-specific alerts</p>
      </div>
      ...
      <Card className="hover-elevate">
        ...
        <CardContent>
          <p className="text-muted-foreground">Configure user alerts and preferences here.</p>
        </CardContent>
      </Card>
    </div>
  );
