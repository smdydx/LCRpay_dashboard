...
const commissionData = [
  { service: "Mobile Recharge", transactions: 8540, earned: "₹1,28,100", rate: "1.5%" },
  { service: "Electricity Bill", transactions: 3890, earned: "₹94,020", rate: "0.6%" },
  { service: "DTH Recharge", transactions: 4320, earned: "₹67,800", rate: "1.0%" },
];
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-muted-foreground mt-1" data-testid="text-page-description">Monitor commission earnings</p>
      </div>
